    ...
    <View style={styles.main_view_style}>
        ...
        <View style={styles.header_viewstyle}>
          ...
          <View style={styles.view_for_text_in_header_style}>
            <Text style={styles.text_header_style}>تغيير كلمة المرور</Text>
          </View>
        ...
        <View style={styles.each_textinput_viewstyle}>
                     <Input placeholder="كلمة المرور القديمة " 
        ...
        <View style={[styles.each_textinput_viewstyle,{marginBottom:RFValue(MARGIN.xlMargin)}]}>
            <Input placeholder="تاكيد كلمة المرور الجديدة"
...
text_header_style:{
    ...
    color:COLORS.black,
    //marginLeft:'15%'
    /*marginLeft:RFValue(MARGIN.lgMargin)*/
},
header_viewstyle:{
    flexDirection:'row',
    height:height*.07,
   // marginBottom:height*.04,
    ...
    ,width:width,
    paddingHorizontal:RFValue(PADDING.xlPadding)
},
each_textinput_viewstyle:{
   ...
   /* alignItems:'center',
    ...
    alignSelf:'center',
    marginLeft:RFValue(MARGIN.mdMargin),
    ...
    justifyContent:'center'*/
    alignSelf:'center',
    marginLeft:RFValue(MARGIN.xlMargin)
