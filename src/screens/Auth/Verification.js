    ...
    render() {
        return (
            <View style={styles.container}>
                <ScrollView>
                    <TouchableOpacity style={[styles.iconStyle, { alignSelf: "flex-start", padding: 10 }]}>
                    ...
                    <View style={{
                        ...
                        <Text
                            style={[styles.titleStyle,]}>الرجاء إدخال الرمز المرسل إلي رقم الهاتف</Text>
                    ...
                    <View style={styles.view}>
                        ...
                        <TouchableOpacity>
                            <Text style={[styles.messageTitleStyle, { color: COLORS.primary, fontWeight: 'bold', }]}>أعد إرسال الرمز</Text>
                        </TouchableOpacity>
                    </View>
