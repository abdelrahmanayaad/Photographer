...
export default class Login extends React.Component {
    ...
    SIGN_IN() {
        ...
        if (Password == "") {
            ...
            password_error = "كلمه المرور يجب لا تقل عن 6 ارقام و حرف كبير و حرف صغير وعلامه مميزه "
            ...
            <View style={styles.container}>
                <ScrollView>
                    <TouchableOpacity style={styles.iconStyle}>
                        <AntDesign name="arrowright" color={'#aaa'} size={RFValue(ICONS.xlIcon)} />
                    </TouchableOpacity>
                    ...
                    <View style={styles.textInputViewStyle}>
                        <TextInput
                            ...
                            onChangeText={(value) => { this.setState({ user_password: value }) }} />
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'center', marginTop: RFValue(200) }}>
